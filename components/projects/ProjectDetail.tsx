        ...
        >
          ...
          >
            ...
            >
              ...
              >
                ...
                <div className="flex flex-wrap gap-1.5 sm:gap-2">
                  {project.technologies.map((tech, index) => (
                    <motion.span
                      key={tech}
                      className="px-2 sm:px-3 py-1 bg-blue-500/20 text-blue-300 rounded-full text-xs sm:text-sm border border-blue-500/30 break-words"
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    {project.detail.challenges.map((challenge, index) => (
                      ...
                      >
                        ...
                        <p className="text-white/80 mb-2 sm:mb-3 leading-relaxed whitespace-pre-line text-sm sm:text-base break-words">
                          {challenge}
                        </p>
                        ...
                        {project.detail?.solutions[index] && (
                          <>
                            ...
                            <p className="text-white/80 leading-relaxed whitespace-pre-line text-sm sm:text-base break-words">
                              {project.detail?.solutions[index]}
                            </p>
              ...
              {/* 링크 */}
              <motion.div
                className="flex gap-2 sm:gap-3 pt-4 border-t border-white/10"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.9, duration: 0.3 }}
              >
                {project.githubUrl && project.githubUrl !== "비공개" && (
                  <motion.a
                    ...
                    className="px-4 sm:px-6 py-2 bg-white/10 text-white/90 rounded text-sm hover:bg-white/20 transition-colors border border-white/20"
                    whileHover={{ scale: 1.05, y: -2 }}
                    whileTap={{ scale: 0.95 }}
                  >
                    GitHub
                ...
                {project.liveUrl && project.liveUrl !== "비공개" && (
                  <motion.a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-4 sm:px-6 py-2 bg-blue-500/20 text-blue-300 rounded text-sm hover:bg-blue-500/30 transition-colors border border-blue-500/30"
                    whileHover={{ scale: 1.05, y: -2 }}
                    whileTap={{ scale: 0.95 }}
                  >
                    웹사이트 보기
